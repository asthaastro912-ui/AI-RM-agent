...
from agent.memory import should_compress, compress_history
...
PROJECT_DIR = os.path.join(os.path.join(BASE_DIR,".."))
LOG_DIR = os.path.join(PROJECT_DIR,"logs")
os.makedirs(LOG_DIR,exist_ok=True)

LOG_FILE = os.path.join(LOG_DIR,"phase9_adapt.log")
...
def safe_openai_call(**kwargs):
    try:
        ...
        logging.exception("OpenAI failure")
...
def get_agent_response(user_input: str) -> str:
    ...
    if should_compress(conversation_history):
...
log_chat("SYSTEM", "Phase 9 session started")

print("=" * 60)
print("PAYTM MONEY AI RM AGENT — PHASE 9 ")
print("=" * 60)
